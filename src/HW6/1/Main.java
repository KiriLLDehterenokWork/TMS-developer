...
public class Main {
    public static void main(String[] args) {
        /*
        Задача 1:
Создать класс HW6.CreditCard c полями номер счета, текущая сумма на счету. Добавьте
метод, который позволяет начислять сумму на кредитную карточку. Добавьте метод,
который позволяет снимать с карточки некоторую сумму. Добавьте метод, который
выводит текущую информацию о карточке. Напишите программу, которая создает три
объекта класса HW6.CreditCard у которых заданы номер счета и начальная сумма.
...
третьей. Выведите на экран текущее состояние всех трех карточек.
        ...
        HW6.CreditCard card1 = new HW6.CreditCard(number1, 0);

        System.out.println("Введите номер карты 2: ");
        long number2 = sc1.nextLong();
        HW6.CreditCard card2 = new HW6.CreditCard(number2, 0);

        System.out.println("Введите номер карты 3: ");
        long number3 = sc1.nextLong();
        HW6.CreditCard card3 = new HW6.CreditCard(number3, 0);
